...
;; auto-save-buffers ¤ÇÂоݤȤ¹¤ë¥ե¡¥¤¥ë̾¤Îµµ¬ɽ¸½
(defvar auto-save-buffers-regexp ""
  "*Regexp that matches `buffer-file-name' to be auto-saved.")

;; auto-save-buffers ¤ǽü³°¤¹¤ë¥ե¡¥¤¥ë̾¤Îµµ¬ɽ¸½
(defvar auto-save-buffers-exclude-regexp "^$"
  "*Regexp that matches `buffer-file-name' not to be auto-saved.")

;;
;; ¤¢¤뤤¤Ï auto-save-buffers ¤ΰú¿ô¤Çµµ¬ɽ¸½¤ò»ØÄꤹ¤뤳¤Ȥâ¤Ǥ­¤ë
;;
;; (require 'auto-save-buffers)
;; (run-with-idle-timer 0.5 t 'auto-save-buffers "\\.c$" "^$") ; .c ¤¤±ÂоÝ
;; (run-with-idle-timer 0.5 t 'auto-save-buffers ""   "\\.h$") ; .h ¤¤±½ü³°
;;
...
;; ¾Êά²Äǽ¤ΰú¿ô¤ǡ¢include/exclude ÍѤÎµµ¬ɽ¸½¤ò»ØÄê¤Ǥ­¤ë
